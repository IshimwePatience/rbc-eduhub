...
const InstructorRating = sequelize.define('InstructorRating', {
  ...
  instructorId: { type: DataTypes.UUID, allowNull: false, field: 'instructor_id', references: { model: 'users', key: 'id' }, onDelete: 'CASCADE' },
  ...
  underscored: true,
  indexes: [
    { fields: ['instructor_id', 'rating'] },
    { fields: ['instructor_id', 'learner_id', 'course_id'], unique: true },
    { fields: ['learner_id'] },
    { fields: ['course_id'] },
    { fields: ['is_published'] },
